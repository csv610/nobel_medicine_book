...
\textit{Determined the chemical structure of antibodies, explaining how these molecules recognize and neutralize specific pathogens with extraordinary precision.}\cite{nobel-1972,lecture-1972}
...
\bibitem{nobel-1972}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1972,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1972/summary/}

\bibitem{lecture-1972}
Gerald M. Edelman, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1972/edelman/lecture/}
\end{thebibliography}
