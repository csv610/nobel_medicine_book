...
\textit{Discovered the citric acid cycle (Krebs cycle), the central metabolic pathway by which cells generate energy from food---a cornerstone of biochemistry.}\cite{nobel-1953,lecture-1953}
...
\bibitem{nobel-1953}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1953,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1953/summary/}

\bibitem{lecture-1953}
Hans Adolf Krebs, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1953/krebs/lecture/}
\end{thebibliography}
