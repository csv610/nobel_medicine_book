...
\textit{Discovered the conditioned reflex, revealing that automatic physiological responses could be learned through association---foundational to understanding behavior and learning.}\cite{nobel-1904,lecture-1904}
...
\bibitem{nobel-1904}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1904,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1904/summary/}

\bibitem{lecture-1904}
Ivan Pavlov, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1904/pavlov/lecture/}
\end{thebibliography}
