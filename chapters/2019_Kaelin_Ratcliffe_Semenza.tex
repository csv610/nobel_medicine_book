...
\textit{Discovered how cells sense and adapt to oxygen availability, explaining a fundamental adaptive mechanism critical for development, immunity, and cancer.}\cite{nobel-2019,lecture-2019}
...
\bibitem{nobel-2019}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 2019,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/2019/summary/}

\bibitem{lecture-2019}
William G. Kaelin Jr., ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/2019/kaelin/lecture/}
\end{thebibliography}
