...
\textit{Discovered that lice transmit epidemic typhus and identified the causative agent (Rickettsia), enabling effective public health measures against the disease.}\cite{nobel-1928,lecture-1928}
...
\bibitem{nobel-1928}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1928,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1928/summary/}

\bibitem{lecture-1928}
Charles Nicolle, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1928/nicolle/lecture/}
\end{thebibliography}
