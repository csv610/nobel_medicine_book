...
\textit{Discovered the role of the sinus and aortic body receptors in regulating respiration, explaining how the body detects changes in blood oxygen and carbon dioxide levels.}\cite{nobel-1938,lecture-1938}
...
\bibitem{nobel-1938}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1938,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1938/summary/}

\bibitem{lecture-1938}
Corneille Heymans, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1938/heymans/lecture/}
\end{thebibliography}
