...
\textit{Elucidated the physiology of the vestibular apparatus (balance organ) in the inner ear, explaining how we maintain equilibrium and spatial orientation.}\cite{nobel-1914,lecture-1914}
...
\bibitem{nobel-1914}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1914,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1914/summary/}

\bibitem{lecture-1914}
Robert B'ar'any, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1914/barany/lecture/}
\end{thebibliography}
