...
\textit{Discovered the mechanism of hormone action---specifically, how epinephrine activates the enzyme adenyl cyclase to produce cyclic AMP as a second messenger.}\cite{nobel-1971,lecture-1971}
...
\bibitem{nobel-1971}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1971,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1971/summary/}

\bibitem{lecture-1971}
Earl W. Sutherland, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1971/sutherland/lecture/}
\end{thebibliography}
