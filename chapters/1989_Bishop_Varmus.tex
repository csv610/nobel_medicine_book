...
\textit{Discovered that cancer-causing genes (oncogenes) arise from normal cellular genes (proto-oncogenes) that have been mutated, explaining the genetic origin of cancer.}\cite{nobel-1989,lecture-1989}
