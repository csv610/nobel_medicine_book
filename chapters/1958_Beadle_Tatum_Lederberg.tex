...
\textit{Demonstrated that genes act by regulating definite chemical events---specifically, that genes control enzyme production---establishing the one gene-one enzyme hypothesis.}\cite{nobel-1958,lecture-1958}
