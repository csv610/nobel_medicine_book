...
\textit{Identified histidine as a fundamental building block of proteins, advancing understanding of protein chemistry and cellular metabolism.}\cite{nobel-1910,lecture-1910}
...
Kossel's characterization of the chemical components of nucleic acids laid the groundwork for one of the major scientific discoveries of the twentieth century: the determination of the structure of DNA by James Watson and Francis Crick in 1953. Watson and Crick's double-helix model of DNA, which revealed the molecular basis of genetic inheritance, was built directly on the chemical foundations that Kossel had established. The nucleotide bases, the sugar-phosphate backbone, and the complementary base pairing that are the structural features of DNA all depend on the chemical components that Kossel identified.
...
\bibitem{nobel-1910}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1910,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1910/summary/}

\bibitem{lecture-1910}
Albrecht Kossel, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1910/kossel/lecture/}
\end{thebibliography}
