...
\textit{Explained complementary physical and chemical aspects of heat production and energy metabolism in contracting muscle.}\cite{nobel-1922,lecture-1922}
...
Hill's experiments used sensitive thermoelectric methods to detect heat released by isolated muscle. He showed that heat production was not simply a by-product of visible shortening: a measurable amount appeared during contraction, followed by a larger recovery component after the work had ended. This made it possible to compare mechanical work and heat quantitatively.

Meyerhof approached the same problem through chemical change. His measurements connected the disappearance of glycogen with the formation and later oxidation of lactic acid. The resulting account explained why muscle could continue working briefly without oxygen and why oxygen was required during recovery. Although later research has revised the details of energy metabolism, the complementary physical and chemical framework remained fundamental.
...
The historical importance of the 1922 work is therefore methodological as well as scientific. It established that physiological processes could be measured in terms of energy balance, chemical intermediates, and reproducible experimental quantities. That approach now underlies indirect calorimetry, exercise testing, mitochondrial diagnostics, and the study of metabolic disease.
...
\bibitem{nobel-1922}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1922,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1922/summary/}

\bibitem{lecture-1922}
Archibald Vivian Hill, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1922/hill/lecture/}
\end{thebibliography}
