...
\textit{Discovered the genetic regulation of enzyme synthesis (the operon model), explaining how genes are switched on and off in response to environmental signals.}\cite{nobel-1965,lecture-1965}
