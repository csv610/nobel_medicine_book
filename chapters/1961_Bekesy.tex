...
\textit{Discovered the physical mechanism by which the cochlea converts sound vibrations into nerve signals, explaining how we hear.}\cite{nobel-1961,lecture-1961}
...
\bibitem{nobel-1961}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1961,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1961/summary/}

\bibitem{lecture-1961}
Georg von B'ek'esy, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1961/bekesy/lecture/}
\end{thebibliography}
