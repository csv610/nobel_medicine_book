...
\textit{Discovered acquired immunological tolerance---the ability of the immune system to be trained to accept foreign tissues---the basis for organ transplantation and autoimmune disease research.}\cite{nobel-1960,lecture-1960}
...
\bibitem{nobel-1960}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1960,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1960/summary/}

\bibitem{lecture-1960}
Frank Macfarlane Burnet, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1960/burnet/lecture/}
\end{thebibliography}
