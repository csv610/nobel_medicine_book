...
\textit{Discovered the coordination function of the midbrain reticular formation, explaining how the brain regulates wakefulness and arousal.}\cite{nobel-1949,lecture-1949}
...
\bibitem{nobel-1949}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1949,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1949/summary/}

\bibitem{lecture-1949}
Walter Rudolf Hess, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1949/hess/lecture/}
\end{thebibliography}
