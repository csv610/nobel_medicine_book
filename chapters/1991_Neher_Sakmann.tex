...
\textit{Developed the patch clamp technique to study single ion channels in cell membranes, revealing how individual protein molecules control nerve impulses.}\cite{nobel-1991,lecture-1991}
