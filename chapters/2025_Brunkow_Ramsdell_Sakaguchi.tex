...
\textit{Identified regulatory T cells (T cells) as the immune system's security guards that prevent immune cells from attacking our own body---discovering peripheral immune tolerance.}\cite{nobel-2025,lecture-2025}
...
\bibitem{nobel-2025}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 2025,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/2025/summary/}

\bibitem{lecture-2025}
Mary E. Brunkow, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/2025/brunkow/lecture/}
\end{thebibliography}
