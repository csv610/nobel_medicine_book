...
\textit{Discovered that genes are split (containing introns and exons) and that RNA is spliced, revealing a fundamental mechanism of gene expression in higher organisms.}
