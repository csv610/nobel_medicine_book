...
\textit{Discovered grid cells and place cells that constitute a positioning system in the brain, explaining how the brain creates a cognitive map of the environment.}\cite{nobel-2014,lecture-2014}
...
\bibitem{nobel-2014}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 2014,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/2014/summary/}

\bibitem{lecture-2014}
John O'Keefe, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/2014/okeefe/lecture/}
\end{thebibliography}
