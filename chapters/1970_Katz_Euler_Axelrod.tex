...
\textit{Discovered how neurotransmitters are stored, released, and inactivated at nerve synapses, explaining the chemical basis of neural communication.}\cite{nobel-1970,lecture-1970}
...
\bibitem{nobel-1970}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1970,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1970/summary/}

\bibitem{lecture-1970}
Bernard Katz, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1970/katz/lecture/}
\end{thebibliography}
