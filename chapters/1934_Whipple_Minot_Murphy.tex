...
\textit{Discovered that liver extract could cure pernicious anemia, identifying a specific dietary factor (later identified as vitamin B12) essential for blood formation.}\cite{nobel-1934,lecture-1934}
...
\bibitem{nobel-1934}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1934,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1934/summary/}

\bibitem{lecture-1934}
George Hoyt Whipple, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1934/whipple/lecture/}
\end{thebibliography}
