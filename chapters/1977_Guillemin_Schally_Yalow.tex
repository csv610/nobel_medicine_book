...
\textit{Discovered the hypothalamic hormones that control the pituitary gland, revealing how the brain regulates growth, reproduction, and metabolism.}\cite{nobel-1977,lecture-1977}
...
\bibitem{nobel-1977}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1977,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1977/summary/}

\bibitem{lecture-1977}
Roger Guillemin, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1977/guillemin/lecture/}
\end{thebibliography}
