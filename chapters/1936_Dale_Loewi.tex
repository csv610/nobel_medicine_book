...
\textit{Discovered that nerve impulses are transmitted chemically (not electrically) across synapses, using acetylcholine as the neurotransmitter---founding the field of neuropharmacology.}\cite{nobel-1936,lecture-1936}
