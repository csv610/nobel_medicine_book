...
\textit{Developed computer-assisted tomography (CT scanning), enabling non-invasive visualization of internal body structures---revolutionizing medical diagnosis.}\cite{nobel-1979,lecture-1979}
...
\bibitem{nobel-1979}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1979,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1979/summary/}

\bibitem{lecture-1979}
Allan M. Cormack, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1979/cormack/lecture/}
\end{thebibliography}
