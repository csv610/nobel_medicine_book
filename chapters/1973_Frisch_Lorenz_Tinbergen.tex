...
\textit{Elucidated the organization of animal behavior, showing that even complex behaviors have innate components that can be studied scientifically.}\cite{nobel-1973,lecture-1973}
...
\bibitem{nobel-1973}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1973,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1973/summary/}

\bibitem{lecture-1973}
Karl von Frisch, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1973/frisch/lecture/}
\end{thebibliography}
