...
\textit{Developed in vitro fertilization (IVF), enabling millions of infertile couples to have children---one of the most significant medical advances of the twentieth century.}\cite{nobel-2010,lecture-2010}
...
\bibitem{nobel-2010}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 2010,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/2010/summary/}

\bibitem{lecture-2010}
Robert G. Edwards, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/2010/edwards/lecture/}
\end{thebibliography}
