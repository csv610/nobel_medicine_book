...
\textit{Discovered that inoculation with malaria could cure general paralysis (tertiary syphilis), pioneering the use of fever therapy for infectious diseases.}\cite{nobel-1927,lecture-1927}
...
\bibitem{nobel-1927}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1927,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1927/summary/}

\bibitem{lecture-1927}
Julius Wagner-Jauregg, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1927/wagner-jauregg/speech/}
\end{thebibliography}
