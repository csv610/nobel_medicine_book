...
\textit{Developed gene targeting in mice using embryonic stem cells, enabling the creation of genetically modified animals to study gene function and model human diseases.}\cite{nobel-2007,lecture-2007}
...
\bibitem{nobel-2007}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 2007,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/2007/summary/}

\bibitem{lecture-2007}
Mario R. Capecchi, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/2007/capecchi/lecture/}
\end{thebibliography}
