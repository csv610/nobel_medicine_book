...
\textit{Discovered that mature cells can be reprogrammed to become pluripotent stem cells, opening new possibilities for regenerative medicine and disease modeling.}\cite{nobel-2012,lecture-2012}
...
\bibitem{nobel-2012}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 2012,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/2012/summary/}

\bibitem{lecture-2012}
John B. Gurdon, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/2012/gurdon/lecture/}
\end{thebibliography}
