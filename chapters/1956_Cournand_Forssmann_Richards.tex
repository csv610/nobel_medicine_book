...
\textit{Pioneered heart catheterization, enabling direct measurement of pressures and flows within the heart---the foundation of modern cardiology and cardiac surgery.}\cite{nobel-1956,lecture-1956}
...
\bibitem{nobel-1956}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1956,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1956/summary/}

\bibitem{lecture-1956}
Andr'e Fr'ed'eric Cournand, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1956/cournand/lecture/}
\end{thebibliography}
