...
\textit{Discovered important principles for drug treatment---specifically, that drugs can be designed to block specific receptors---founding the field of rational drug design.}
...
Perhaps majorly, the work of the three laureates established the principle that drugs can be designed rationally, based on a detailed understanding of the molecular targets they interact with. This principle has become the dominant paradigm in drug discovery, and it has led to the development of many of a major drugs of the past half-century, including statins, ACE inhibitors, angiotensin receptor blockers, and the targeted cancer therapies that have transformed the treatment of cancer.
