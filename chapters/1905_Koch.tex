...
\textit{Developed methods to isolate and culture tuberculosis bacteria, formulated Koch's postulates for proving that a specific organism causes a specific disease, and made foundational discoveries in cholera and anthrax.}\cite{nobel-1905,lecture-1905}
...
\bibitem{nobel-1905}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1905,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1905/summary/}

\bibitem{lecture-1905}
Robert Koch, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1905/koch/lecture/}
\end{thebibliography}
