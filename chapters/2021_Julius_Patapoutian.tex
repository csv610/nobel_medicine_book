...
\textit{Discovered receptors for temperature and touch (TRPV1, Piezo channels), explaining how the body senses physical stimuli---opening new avenues for pain therapy.}\cite{nobel-2021,lecture-2021}
...
\bibitem{nobel-2021}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 2021,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/2021/summary/}

\bibitem{lecture-2021}
David Julius, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/2021/julius/lecture/}
\end{thebibliography}
