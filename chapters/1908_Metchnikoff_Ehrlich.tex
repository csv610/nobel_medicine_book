...
\textit{Discovered phagocytosis (cellular immunity) and developed humoral immunity theory, establishing the two pillars of the immune system.}\cite{nobel-1908,lecture-1908}
...
The contributions of Metchnikoff and Ehrlich to immunology have had a significant impact on medicine. Together, they established the foundations of the science of immunology---one of the major and rapidly advancing fields of modern medicine.
...
\bibitem{nobel-1908}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1908,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1908/summary/}

\bibitem{lecture-1908}
'{E}lie Metchnikoff, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1908/mechnikov/lecture/}
\end{thebibliography}
