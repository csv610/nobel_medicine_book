...
\textit{Discovered the genetic basis of immune recognition (the MHC system), explaining how the immune system distinguishes self from non-self.}\cite{nobel-1980,lecture-1980}
...
\bibitem{nobel-1980}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1980,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1980/summary/}

\bibitem{lecture-1980}
Baruj Benacerraf, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1980/benacerraf/lecture/}
\end{thebibliography}
