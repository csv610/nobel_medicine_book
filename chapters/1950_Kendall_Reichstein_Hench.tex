...
\textit{Isolated and characterized the hormones of the adrenal cortex (cortisone and related steroids), revolutionizing the treatment of rheumatic and inflammatory diseases.}\cite{nobel-1950,lecture-1950}
...
\bibitem{nobel-1950}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1950,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1950/summary/}

\bibitem{lecture-1950}
Edward Calvin Kendall, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1950/kendall/lecture/}
\end{thebibliography}
