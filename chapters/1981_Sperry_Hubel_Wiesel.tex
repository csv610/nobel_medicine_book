...
\textit{Discovered the functional specialization of the cerebral hemispheres, explaining how the left and right brain process different types of information.}\cite{nobel-1981,lecture-1981}

\section{Official Citation}

for his discoveries concerning the functional specialization of the cerebral hemispheres; and for their discoveries concerning information processing in the visual system
...
\bibitem{nobel-1981}
Nobel Prize Outreach, ``The Nobel Prize in Physiology or Medicine 1981,''\emph{NobelPrize.org}.\\
\url{https://www.nobelprize.org/prizes/medicine/1981/summary/}

\bibitem{lecture-1981}
Roger W. Sperry, ``Nobel Lecture,''\emph{NobelPrize.org}. Winner-authored primary source; downloadable from the official Nobel Prize archive.\\
\url{https://www.nobelprize.org/prizes/medicine/1981/sperry/lecture/}
\end{thebibliography}
